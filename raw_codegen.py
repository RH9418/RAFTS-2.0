...
def test_example(page: Page) -> None:
    ...
    page.get_by_role("textbox", name="e.g. Global Filters").click()
    page.get_by_role("textbox", name="e.g. Global Filters").fill("Alert Types")
    page.get_by_role("button", name="Add Section").click()
    ...
    page.get_by_role("textbox", name="e.g. Global Filters").click()
    page.get_by_role("textbox", name="e.g. Global Filters").fill("Alerts Sumary")
    page.get_by_role("button", name="Add Section").click()
    ...
    page.locator("#ag-2417-input").check()

    page.locator("#ag-2415-input").check()

    page.locator("#ag-2413-input").check()
    ...
    page.locator("#ag-6862-input").check()

    page.locator("#ag-6860-input").check()
    ...
    page.get_by_role("textbox", name="e.g. Global Filters").fill("Weekly Summary Section")
    ...
    page.get_by_role("textbox", name="e.g. Global Filters").click()
    page.get_by_role("textbox", name="e.g. Global Filters").fill("Events Grid")
    page.get_by_role("button", name="Add Section").click()
